...
public class XmlUtils {
    ...
    public static final void writeMapXml(Map val, OutputStream out)
        ...
        serializer.setOutput(out, Charset.forName("UTF-8").name());//StandardCharsets.UTF_8.name()
    ...
    public static final HashMap<String, ?> readMapXml(InputStream in)
        ...
        parser.setInput(in, Charset.forName("UTF-8").name());//StandardCharsets.UTF_8.name()
     ...
     * @hide
     */
    public static final Map<String, ?> readThisArrayMapXml(XmlPullParser parser, String endTag,
                                                           String[] name, ReadMapCallback callback)
            throws XmlPullParserException, IOException {
        //ArrayMap<String, Object> map = new ArrayMap<>();

        Map<String, Object> map = new androidx.collection.ArrayMap<>();
